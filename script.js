...
console.log(SCHOOl)
//SCHOOl = "OtherCollege";
//  the error is an Assignement to constant variable, we cannot reassign varaibles declared with const.
// ==========================
...
// write code here
console.log("2"+3) //because we are adding a string and a number which cant be added mathmaticly
console.log(2 + "3")
console.log(2 + 3)
...
console.log(a)
//console.log(b) here b is not defined so only the value a is displayed because let is block scoped while var is function scoped.
// ==================
// TODO-8: ARRAYS (CORE)
// ==================
...
nums.pop()
console.log("the final result after pop",nums)
